...
print("Similar to man:")
print(most_similar("man", model, word_to_idx, idx_to_word))
print("Similar to Russia:")
print(most_similar("russia", model, word_to_idx, idx_to_word))
print("Similar to death:")
print(most_similar("death", model, word_to_idx, idx_to_word))
